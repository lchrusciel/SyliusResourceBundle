...
final class Metadata implements MetadataInterface
{
    ...
    public function getAction(string $name): string
    {
        if (!$this->hasAction($name)) {
            throw new \InvalidArgumentException(sprintf('Action "%s" is not configured for resource "%s".', $name, $this->getAlias()));
        }

        return $this->parameters['classes']['actions'][$name];
    }
    ...
    {
        return isset($this->parameters['classes']['actions'][$name]);
    }
